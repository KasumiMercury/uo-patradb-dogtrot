...
// CategoryDescriptionTemplateCreate is the builder for creating a CategoryDescriptionTemplate entity.
...
func (cdtc *CategoryDescriptionTemplateCreate) SetID(s string) *CategoryDescriptionTemplateCreate {
	cdtc.mutation.SetID(s)
	return cdtc
}

// SetNillableID sets the "id" field if the given value is not nil.
func (cdtc *CategoryDescriptionTemplateCreate) SetNillableID(s *string) *CategoryDescriptionTemplateCreate {
	if s != nil {
		cdtc.SetID(*s)
	}
	return cdtc
...
func (cdtc *CategoryDescriptionTemplateCreate) AddDescriptionIDs(ids ...string) *CategoryDescriptionTemplateCreate {
...
// Save creates the CategoryDescriptionTemplate in the database.
func (cdtc *CategoryDescriptionTemplateCreate) Save(ctx context.Context) (*CategoryDescriptionTemplate, error) {
	cdtc.defaults()
	return withHooks(ctx, cdtc.sqlSave, cdtc.mutation, cdtc.hooks)
}

// SaveX calls Save and panics if Save returns an error.
func (cdtc *CategoryDescriptionTemplateCreate) SaveX(ctx context.Context) *CategoryDescriptionTemplate {
	v, err := cdtc.Save(ctx)
	if err != nil {
		panic(err)
	}
...
func (cdtc *CategoryDescriptionTemplateCreate) defaults() {
	if _, ok := cdtc.mutation.ID(); !ok {
		v := categorydescriptiontemplate.DefaultID()
...
func (cdtc *CategoryDescriptionTemplateCreate) sqlSave(ctx context.Context) (*CategoryDescriptionTemplate, error) {
	...
	if _spec.ID.Value != nil {
		if id, ok := _spec.ID.Value.(string); ok {
			...
			return nil, fmt.Errorf("unexpected CategoryDescriptionTemplate.ID type: %T", _spec.ID.Value)
		}
	}
...
func (cdtc *CategoryDescriptionTemplateCreate) createSpec() (*CategoryDescriptionTemplate, *sqlgraph.CreateSpec) {
	var (
		_node = &CategoryDescriptionTemplate{config: cdtc.config}
		_spec = sqlgraph.NewCreateSpec(categorydescriptiontemplate.Table, sqlgraph.NewFieldSpec(categorydescriptiontemplate.FieldID, field.TypeString))
	)
...
// CategoryDescriptionTemplateCreateBulk is the builder for creating many CategoryDescriptionTemplate entities in bulk.
...
// Save creates the CategoryDescriptionTemplate entities in the database.
func (cdtcb *CategoryDescriptionTemplateCreateBulk) Save(ctx context.Context) ([]*CategoryDescriptionTemplate, error) {
	if cdtcb.err != nil {
		return nil, cdtcb.err
	}
	specs := make([]*sqlgraph.CreateSpec, len(cdtcb.builders))
	nodes := make([]*CategoryDescriptionTemplate, len(cdtcb.builders))
...
func (cdtcb *CategoryDescriptionTemplateCreateBulk) SaveX(ctx context.Context) []*CategoryDescriptionTemplate {
