...
// CategoryDescriptionTemplateUpdate is the builder for updating CategoryDescriptionTemplate entities.
...
func (cdtu *CategoryDescriptionTemplateUpdate) Where(ps ...predicate.CategoryDescriptionTemplate) *CategoryDescriptionTemplateUpdate {
...
func (cdtu *CategoryDescriptionTemplateUpdate) AddDescriptionIDs(ids ...string) *CategoryDescriptionTemplateUpdate {
...
func (cdtu *CategoryDescriptionTemplateUpdate) RemoveDescriptionIDs(ids ...string) *CategoryDescriptionTemplateUpdate {
...
func (cdtu *CategoryDescriptionTemplateUpdate) sqlSave(ctx context.Context) (n int, err error) {
	_spec := sqlgraph.NewUpdateSpec(categorydescriptiontemplate.Table, categorydescriptiontemplate.Columns, sqlgraph.NewFieldSpec(categorydescriptiontemplate.FieldID, field.TypeString))
	...
	if value, ok := cdtu.mutation.Text(); ok {
		_spec.SetField(categorydescriptiontemplate.FieldText, field.TypeString, value)
	}
	if value, ok := cdtu.mutation.StartUseAt(); ok {
		_spec.SetField(categorydescriptiontemplate.FieldStartUseAt, field.TypeTime, value)
	}
	if cdtu.mutation.StartUseAtCleared() {
		_spec.ClearField(categorydescriptiontemplate.FieldStartUseAt, field.TypeTime)
	}
	if value, ok := cdtu.mutation.LastUseAt(); ok {
		_spec.SetField(categorydescriptiontemplate.FieldLastUseAt, field.TypeTime, value)
	}
	if cdtu.mutation.LastUseAtCleared() {
		_spec.ClearField(categorydescriptiontemplate.FieldLastUseAt, field.TypeTime)
	}
	if cdtu.mutation.DescriptionsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: true,
			Table:   categorydescriptiontemplate.DescriptionsTable,
			Columns: []string{categorydescriptiontemplate.DescriptionsColumn},
			Bidi:    false,
...
// CategoryDescriptionTemplateUpdateOne is the builder for updating a single CategoryDescriptionTemplate entity.
...
// AddDescriptionIDs adds the "descriptions" edge to the Description entity by IDs.
func (cdtuo *CategoryDescriptionTemplateUpdateOne) AddDescriptionIDs(ids ...string) *CategoryDescriptionTemplateUpdateOne {
...
// RemoveDescriptionIDs removes the "descriptions" edge to Description entities by IDs.
func (cdtuo *CategoryDescriptionTemplateUpdateOne) RemoveDescriptionIDs(ids ...string) *CategoryDescriptionTemplateUpdateOne {
...
// Where appends a list predicates to the CategoryDescriptionTemplateUpdate builder.
func (cdtuo *CategoryDescriptionTemplateUpdateOne) Where(ps ...predicate.CategoryDescriptionTemplate) *CategoryDescriptionTemplateUpdateOne {
...
// Save executes the query and returns the updated CategoryDescriptionTemplate entity.
func (cdtuo *CategoryDescriptionTemplateUpdateOne) Save(ctx context.Context) (*CategoryDescriptionTemplate, error) {
	return withHooks(ctx, cdtuo.sqlSave, cdtuo.mutation, cdtuo.hooks)
}

// SaveX is like Save, but panics if an error occurs.
func (cdtuo *CategoryDescriptionTemplateUpdateOne) SaveX(ctx context.Context) *CategoryDescriptionTemplate {
...
func (cdtuo *CategoryDescriptionTemplateUpdateOne) sqlSave(ctx context.Context) (_node *CategoryDescriptionTemplate, err error) {
	_spec := sqlgraph.NewUpdateSpec(categorydescriptiontemplate.Table, categorydescriptiontemplate.Columns, sqlgraph.NewFieldSpec(categorydescriptiontemplate.FieldID, field.TypeString))
	id, ok := cdtuo.mutation.ID()
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`ent: missing "CategoryDescriptionTemplate.id" for update`)}
	}
	...
	if fields := cdtuo.fields; len(fields) > 0 {
		...
		for _, f := range fields {
			...
			if f != categorydescriptiontemplate.FieldID {
	...
	_node = &CategoryDescriptionTemplate{config: cdtuo.config}
