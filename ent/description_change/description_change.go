...
const (
	// Label holds the string label denoting the description_change type in the database.
	...
	// Table holds the table name of the description_change in the database.
...
// Columns holds all SQL columns for description_change fields.
var Columns = []string{
	FieldID,
	FieldRaw,
	FieldVariable,
...
// OrderOption defines the ordering options for the Description_change queries.
