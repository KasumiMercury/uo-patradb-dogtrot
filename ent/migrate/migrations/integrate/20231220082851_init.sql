...
CREATE TABLE `descriptions` (`id` varchar(26) NOT NULL, `raw` varchar(5000) NOT NULL, `variable` varchar(255) NULL, `created_at` timestamp NOT NULL, `updated_at` timestamp NOT NULL, `periodic_id` varchar(26) NULL, `category_id` varchar(26) NULL, `video_id` varchar(26) NOT NULL, PRIMARY KEY (`id`), UNIQUE INDEX `video_id` (`video_id`)) CHARSET utf8mb4 COLLATE utf8mb4_bin;
...
-- Create "videos" table
CREATE TABLE `videos` (`id` varchar(26) NOT NULL, `source_id` varchar(12) NOT NULL, `title` varchar(100) NOT NULL, `duration_seconds` bigint NULL, `is_collaboration` bool NOT NULL DEFAULT false, `status` varchar(255) NOT NULL, `chat_id` varchar(255) NULL, `has_time_range` bool NOT NULL DEFAULT false, `scheduled_at` timestamp NULL, `actual_start_at` timestamp NULL, `actual_end_at` timestamp NULL, `published_at` timestamp NOT NULL, `created_at` timestamp NOT NULL, `updated_at` timestamp NOT NULL, PRIMARY KEY (`id`), UNIQUE INDEX `source_id` (`source_id`)) CHARSET utf8mb4 COLLATE utf8mb4_bin;
