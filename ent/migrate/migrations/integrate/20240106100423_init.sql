...
-- Create "videos" table
CREATE TABLE `videos` (`id` varchar(26) NOT NULL, `source_id` varchar(12) NOT NULL, `title` varchar(100) NOT NULL, `duration_seconds` bigint NULL, `is_collaboration` bool NOT NULL DEFAULT false, `status` varchar(255) NOT NULL, `chat_id` varchar(255) NULL, `has_time_range` bool NOT NULL DEFAULT false, `capture_permission` bool NOT NULL DEFAULT true, `scheduled_at` timestamp NULL, `actual_start_at` timestamp NULL, `actual_end_at` timestamp NULL, `published_at` timestamp NOT NULL, `numbering` bigint NULL, `created_at` timestamp NOT NULL, `updated_at` timestamp NOT NULL, PRIMARY KEY (`id`), UNIQUE INDEX `source_id` (`source_id`)) CHARSET utf8mb4 COLLATE utf8mb4_bin;
...
CREATE TABLE `video_tags` (`id` varchar(26) NOT NULL, `title` varchar(50) NOT NULL, `normalized_title` varchar(50) NOT NULL, `series_numbering` bigint NULL, PRIMARY KEY (`id`), UNIQUE INDEX `normalized_title` (`normalized_title`), INDEX `videotag_title` (`title`)) CHARSET utf8mb4 COLLATE utf8mb4_bin;
