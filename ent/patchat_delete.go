...
// PatChatDelete is the builder for deleting a PatChat entity.
...
func (pcd *PatChatDelete) Where(ps ...predicate.PatChat) *PatChatDelete {
...
func (pcd *PatChatDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(patchat.Table, sqlgraph.NewFieldSpec(patchat.FieldID, field.TypeString))
...
// PatChatDeleteOne is the builder for deleting a single PatChat entity.
type PatChatDeleteOne struct {
	pcd *PatChatDelete
}

// Where appends a list predicates to the PatChatDelete builder.
func (pcdo *PatChatDeleteOne) Where(ps ...predicate.PatChat) *PatChatDeleteOne {
...
func (pcdo *PatChatDeleteOne) Exec(ctx context.Context) error {
	...
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{patchat.Label}
	default:
		return nil
	}
}
