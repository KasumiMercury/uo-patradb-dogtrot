...
const (
	// Label holds the string label denoting the periodic_description_template type in the database.
	Label = "periodic_description_template"
	...
	// Table holds the table name of the periodic_description_template in the database.
	Table = "periodic_description_templates"
	...
	DescriptionsColumn = "periodic_template_id"
)

// Columns holds all SQL columns for periodic_description_template fields.
var Columns = []string{
	FieldID,
	FieldText,
	FieldStartUseAt,
...
// OrderOption defines the ordering options for the Periodic_description_template queries.
