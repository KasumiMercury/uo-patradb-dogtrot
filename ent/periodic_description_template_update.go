...
// PeriodicDescriptionTemplateUpdate is the builder for updating Periodic_description_template entities.
...
func (pdtu *PeriodicDescriptionTemplateUpdate) Where(ps ...predicate.Periodic_description_template) *PeriodicDescriptionTemplateUpdate {
...
func (pdtu *PeriodicDescriptionTemplateUpdate) AddDescriptionIDs(ids ...pulid.ID) *PeriodicDescriptionTemplateUpdate {
...
func (pdtu *PeriodicDescriptionTemplateUpdate) RemoveDescriptionIDs(ids ...pulid.ID) *PeriodicDescriptionTemplateUpdate {
...
func (pdtu *PeriodicDescriptionTemplateUpdate) sqlSave(ctx context.Context) (n int, err error) {
	_spec := sqlgraph.NewUpdateSpec(periodic_description_template.Table, periodic_description_template.Columns, sqlgraph.NewFieldSpec(periodic_description_template.FieldID, field.TypeString))
	...
	if pdtu.mutation.StartUseAtCleared() {
		_spec.ClearField(periodic_description_template.FieldStartUseAt, field.TypeTime)
	}
	...
	if pdtu.mutation.LastUseAtCleared() {
		_spec.ClearField(periodic_description_template.FieldLastUseAt, field.TypeTime)
	}
...
// PeriodicDescriptionTemplateUpdateOne is the builder for updating a single Periodic_description_template entity.
...
// AddDescriptionIDs adds the "descriptions" edge to the Description entity by IDs.
func (pdtuo *PeriodicDescriptionTemplateUpdateOne) AddDescriptionIDs(ids ...pulid.ID) *PeriodicDescriptionTemplateUpdateOne {
...
// RemoveDescriptionIDs removes the "descriptions" edge to Description entities by IDs.
func (pdtuo *PeriodicDescriptionTemplateUpdateOne) RemoveDescriptionIDs(ids ...pulid.ID) *PeriodicDescriptionTemplateUpdateOne {
...
// Where appends a list predicates to the PeriodicDescriptionTemplateUpdate builder.
func (pdtuo *PeriodicDescriptionTemplateUpdateOne) Where(ps ...predicate.Periodic_description_template) *PeriodicDescriptionTemplateUpdateOne {
...
// Save executes the query and returns the updated Periodic_description_template entity.
func (pdtuo *PeriodicDescriptionTemplateUpdateOne) Save(ctx context.Context) (*Periodic_description_template, error) {
	return withHooks(ctx, pdtuo.sqlSave, pdtuo.mutation, pdtuo.hooks)
}

// SaveX is like Save, but panics if an error occurs.
func (pdtuo *PeriodicDescriptionTemplateUpdateOne) SaveX(ctx context.Context) *Periodic_description_template {
...
func (pdtuo *PeriodicDescriptionTemplateUpdateOne) sqlSave(ctx context.Context) (_node *Periodic_description_template, err error) {
	_spec := sqlgraph.NewUpdateSpec(periodic_description_template.Table, periodic_description_template.Columns, sqlgraph.NewFieldSpec(periodic_description_template.FieldID, field.TypeString))
	id, ok := pdtuo.mutation.ID()
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`ent: missing "Periodic_description_template.id" for update`)}
	}
	...
	if fields := pdtuo.fields; len(fields) > 0 {
		...
		for _, f := range fields {
			...
			if f != periodic_description_template.FieldID {
	...
	_node = &Periodic_description_template{config: pdtuo.config}
