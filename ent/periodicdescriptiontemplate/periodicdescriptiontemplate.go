...
const (
	// Label holds the string label denoting the periodicdescriptiontemplate type in the database.
	...
	DescriptionsColumn = "periodic_id"
)

// Columns holds all SQL columns for periodicdescriptiontemplate fields.
var Columns = []string{
	FieldID,
	FieldText,
	FieldStartUseAt,
...
// OrderOption defines the ordering options for the PeriodicDescriptionTemplate queries.
