...
// VideoDisallowRangeDelete is the builder for deleting a Video_disallow_range entity.
...
func (vdrd *VideoDisallowRangeDelete) Where(ps ...predicate.Video_disallow_range) *VideoDisallowRangeDelete {
...
func (vdrd *VideoDisallowRangeDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(video_disallow_range.Table, sqlgraph.NewFieldSpec(video_disallow_range.FieldID, field.TypeString))
...
// VideoDisallowRangeDeleteOne is the builder for deleting a single Video_disallow_range entity.
type VideoDisallowRangeDeleteOne struct {
	vdrd *VideoDisallowRangeDelete
}

// Where appends a list predicates to the VideoDisallowRangeDelete builder.
func (vdrdo *VideoDisallowRangeDeleteOne) Where(ps ...predicate.Video_disallow_range) *VideoDisallowRangeDeleteOne {
...
func (vdrdo *VideoDisallowRangeDeleteOne) Exec(ctx context.Context) error {
	...
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{video_disallow_range.Label}
	default:
		return nil
	}
}
