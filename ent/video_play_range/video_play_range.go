...
const (
	// Label holds the string label denoting the video_play_range type in the database.
	Label = "video_play_range"
	...
	EdgeVideo = "video"
	// Table holds the table name of the video_play_range in the database.
	Table = "video_play_ranges"
	// VideoTable is the table that holds the video relation/edge.
	VideoTable = "video_play_ranges"
	...
	VideoColumn = "video_video_play_ranges"
)

// Columns holds all SQL columns for video_play_range fields.
var Columns = []string{
	FieldID,
	FieldStartSeconds,
	FieldEndSeconds,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "video_play_ranges"
// table and are not defined as standalone fields in the schema.
var ForeignKeys = []string{
	"video_video_play_ranges",
}
...
var (
	// DefaultStartSeconds holds the default value on creation for the "start_seconds" field.
	DefaultStartSeconds int
	// DefaultID holds the default value on creation for the "id" field.
	DefaultID func() pulid.ID
)

// OrderOption defines the ordering options for the Video_play_range queries.
