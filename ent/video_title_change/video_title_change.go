...
const (
	// Label holds the string label denoting the video_title_change type in the database.
	...
	EdgeVideo = "video"
	// Table holds the table name of the video_title_change in the database.
...
// Columns holds all SQL columns for video_title_change fields.
var Columns = []string{
	FieldID,
	FieldTitle,
...
// OrderOption defines the ordering options for the Video_title_change queries.
