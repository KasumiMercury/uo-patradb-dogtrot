...
// VideoTitleChangeDelete is the builder for deleting a Video_title_change entity.
...
func (vtcd *VideoTitleChangeDelete) Where(ps ...predicate.Video_title_change) *VideoTitleChangeDelete {
...
func (vtcd *VideoTitleChangeDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(video_title_change.Table, sqlgraph.NewFieldSpec(video_title_change.FieldID, field.TypeString))
...
// VideoTitleChangeDeleteOne is the builder for deleting a single Video_title_change entity.
type VideoTitleChangeDeleteOne struct {
	vtcd *VideoTitleChangeDelete
}

// Where appends a list predicates to the VideoTitleChangeDelete builder.
func (vtcdo *VideoTitleChangeDeleteOne) Where(ps ...predicate.Video_title_change) *VideoTitleChangeDeleteOne {
...
func (vtcdo *VideoTitleChangeDeleteOne) Exec(ctx context.Context) error {
	...
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{video_title_change.Label}
	default:
		return nil
	}
}
