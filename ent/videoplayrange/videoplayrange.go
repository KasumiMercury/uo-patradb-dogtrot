...
const (
	// Label holds the string label denoting the videoplayrange type in the database.
	...
	EdgeVideo = "video"
	// Table holds the table name of the videoplayrange in the database.
...
// Columns holds all SQL columns for videoplayrange fields.
var Columns = []string{
	FieldID,
	FieldStartSeconds,
	FieldEndSeconds,
...
// OrderOption defines the ordering options for the VideoPlayRange queries.
