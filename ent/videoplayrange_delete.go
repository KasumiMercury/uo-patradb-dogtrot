...
// VideoPlayRangeDelete is the builder for deleting a VideoPlayRange entity.
...
func (vprd *VideoPlayRangeDelete) Where(ps ...predicate.VideoPlayRange) *VideoPlayRangeDelete {
...
func (vprd *VideoPlayRangeDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(videoplayrange.Table, sqlgraph.NewFieldSpec(videoplayrange.FieldID, field.TypeString))
...
// VideoPlayRangeDeleteOne is the builder for deleting a single VideoPlayRange entity.
type VideoPlayRangeDeleteOne struct {
	vprd *VideoPlayRangeDelete
}

// Where appends a list predicates to the VideoPlayRangeDelete builder.
func (vprdo *VideoPlayRangeDeleteOne) Where(ps ...predicate.VideoPlayRange) *VideoPlayRangeDeleteOne {
...
func (vprdo *VideoPlayRangeDeleteOne) Exec(ctx context.Context) error {
	...
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{videoplayrange.Label}
	default:
		return nil
	}
}
